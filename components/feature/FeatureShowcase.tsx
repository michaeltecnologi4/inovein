                ...
                >
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1A1A1A] leading-tight">
                        ...
                        <span className="relative inline-block">
                            ...
                            <motion.span
                                className="absolute bottom-1 left-0 right-0 h-3 bg-[#485C11]/20"
                                initial={{ scaleX: 0 }}
                    ...
                    <ul className="mt-6 md:mt-8 space-y-4">
                        {benefits.map((item, i) => (
                            ...
                            >
                                <div className="w-6 h-6 rounded-md bg-[#485C11]/10 flex items-center justify-center border border-[#485C11]/20">
                                    <FiCheck className="text-[#485C11]" />
                                </div>
                                {item}
                            </motion.li>
                        ))}
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="mt-8 px-6 py-3 bg-[#485C11] text-white font-semibold rounded-xl shadow-md hover:bg-[#3d4f10] transition"
                    >
                        Fale com a gente
                    </motion.button>
                </motion.div>
