...
export default function BenefitsBanner() {
    return (
        <motion.section
            className="relative w-full overflow-hidden  bg-gradient-to-br from-[#3A3B3B] via-[#8B8E8F] to-[#3A3B3B] text-white py-12 md:py-16 lg:py-20 px-6 md:px-10 lg:px-14 shadow-2xl"
        ...
        >
            ...
            {/* Soft Glow Blobs */}
            <motion.div
                className="absolute top-[-120px] left-[-80px] w-[300px] h-[300px] rounded-full bg-[#8B8E8F]/35 blur-[100px]"
                animate={{ x: [0, 20, 0], y: [0, 15, 0] }}
                transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
            />

            <motion.div
                className="absolute bottom-[-120px] right-[-80px] w-[320px] h-[320px] rounded-full bg-[#3A3B3B]/35 blur-[120px]"
                animate={{ x: [0, -20, 0], y: [0, -15, 0] }}
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 items-center">
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.span
                                className="absolute bottom-2 left-0 right-0 h-3 bg-white/25 -z-0"
                                initial={{ scaleX: 0 }}
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="mt-6 md:mt-8 px-6 md:px-8 py-3 md:py-4 rounded-full bg-white text-[#3A3B3B] font-semibold shadow-lg hover:shadow-2xl transition-all text-sm md:text-base relative overflow-hidden group"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                    ...
                    >
                        ...
                        <motion.div
                            className="absolute inset-0 bg-gradient-to-r from-[#8B8E8F]/15 to-[#3A3B3B]/15 rounded-full"
                ...
                >
                    ...
                    {[...Array(4)].map((_, i) => (
                        <motion.div
                            key={i}
                            className="absolute w-6 h-6 md:w-8 md:h-8 rounded-lg bg-gradient-to-br from-[#8B8E8F]/40 to-[#3A3B3B]/40 border border-white/10 backdrop-blur-lg shadow-md"
                            style={{
